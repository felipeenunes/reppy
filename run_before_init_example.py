...
conn = psycopg2.connect(user="natalia", password="1234", host="localhost", port="5432")
...
cursor.close()
conn.close()
conn = psycopg2.connect(database="reppy", user="natalia", password="1234", host="localhost", port="5432")
